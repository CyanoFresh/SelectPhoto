    ...
    >
        ...
        <div class="panel-body">
            <div class="link-info">
                <div class="link-name">
                    ...
                    <?php if ($model->submitted): ?>
                        <div class="link-submitted" title="<?= Yii::t('app', 'Завершено користувачем') ?>">
            ...
            <div class="link-controls">
                <button class="btn btn-default" title="<?= Yii::t('app', 'Копіювати посилання в буфер обміну') ?>" onclick="copy('link-<?= $model->id ?>'); return false">
