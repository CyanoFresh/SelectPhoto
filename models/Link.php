...
class Link extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', 'ID'),
            'active' => Yii::t('app', 'Активне'),
            'link' => Yii::t('app', 'Посилання'),
            'name' => Yii::t('app', 'Назва'),
            'project_id' => Yii::t('app', 'Проект'),
            'user_id' => Yii::t('app', 'Користувач'),
            'submitted' => Yii::t('app', 'Завершено Користувачем'),
            'allow_comment' => Yii::t('app', 'Дозволити коментування'),
            'disable_after_submit' => Yii::t('app', 'Відключити после завершения'),
            'watermark' => Yii::t('app', 'Ставити watermark'),
            'max_photos' => Yii::t('app', 'Макс. Фото'),
            'show_tutorial' => Yii::t('app', 'Показувати інструкцію'),
            'disable_right_click' => Yii::t('app', 'Відключити скачування фото'),
            'greeting_message' => Yii::t('app', 'Повідомлення Привітання'),
            'created_at' => Yii::t('app', 'Дата Створення'),
            'submitted_at' => Yii::t('app', 'Дата Завершення'),
        ];
    }
